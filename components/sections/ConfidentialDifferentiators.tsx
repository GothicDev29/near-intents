        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-16">
          {differentiators.map((item, idx) => (
            <RevealOnScroll key={idx} delay={idx * 0.15}>
              <div className="bg-[#242424] border border-white/10 p-5 md:p-8 rounded-[16px] h-full relative group hover:border-brand-orange/30 shadow-lg flex flex-col transition-colors duration-300">
