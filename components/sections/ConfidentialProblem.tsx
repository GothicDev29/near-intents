      ...
      <div className="max-w-7xl mx-auto">
        <RevealOnScroll>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="w-full h-px mb-6 mx-auto" style={{ background: 'linear-gradient(to right, #FB4D01, transparent)' }} />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#242424] border border-white/10 p-5 rounded-[16px] flex gap-3 items-start mt-2 mx-auto max-w-2xl">
