      ...
      <div className="flex-grow flex flex-col justify-center px-8 md:px-20 relative z-10 pt-32 pb-10">
        <div className="max-w-7xl mx-auto w-full">
          <div className="max-w-4xl">
            ...
            <div className="w-full md:w-1/2 h-px bg-gradient-to-r from-orange-500 to-transparent my-6"></div>
            ...
            <div className="mt-24">
              ...
              <div className="text-white mt-1 text-lg font-medium">
                all-time volume across <span className="text-orange-500 font-bold">35+ chains</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="animate-marquee flex items-center gap-16 px-8 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500">
            {doubledLogos.map((logo, i) => (
              <div key={i} className="flex items-center gap-3 group cursor-default min-w-max">
                <div className="w-10 h-10 rounded-[16px] bg-zinc-900 border border-white/10 flex items-center justify-center group-hover:border-orange-500/50 transition-colors">
                  <Globe size={18} className="text-zinc-400 group-hover:text-orange-500 transition-colors" />
                </div>
